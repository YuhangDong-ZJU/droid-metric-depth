...
or 13. It selects the ZED SDK build from the OS, `CUDA_VERSION`, `nvcc`, and
finally the NVIDIA driver. Set `ZED_CUDA_MAJOR=12` or `ZED_CUDA_MAJOR=13` only
when automatic detection does not match the cluster image.
